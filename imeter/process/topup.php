...
if(isset($_POST['topup_code'])){
	...
	//w	hen the user didnt post a topup code
...
function recharger($code)
{
	...
	if($check->num_rows>0){
		...
		//i		f the topup code has been used
		if($used!=0){
		...
		//w		hen the topup code is incorrect
...
//respose is already recorded in class
 $collected->recharge_meter($code,$meter_no);
