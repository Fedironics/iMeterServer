...
<head>
  ...
  <title>iMeter Admin Login</title>
...
<div class="login-box">
 ...
 echo $session->show_messages();
  ...
  <img src='images/imeter.jpg' style='width:80%;display:block;margin:auto'/>
    ...
    <form action="process/alogins.php" method="post">
      <div class="form-group has-feedback">
        <input type="text" value="<?php echo $email;?>" class="form-control" name='userid' placeholder="UserId">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name='login_keeping'> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
