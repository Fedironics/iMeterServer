...
//some database to variables of superadmin
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="pay_print.php?amt=<?php echo $pay ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
  ...
  <footer class="main-footer no-print">
    ...
    <strong>Copyright &copy; 2014-2015 <a href="http://imeter.com">Fedironics Institute Of Research (FIRE)</a>.</strong> All rights
    reserved.
  </footer>
